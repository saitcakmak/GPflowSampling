...
def plot_line(x, y, *args, zorder=10, ax=None, alpha=0.9, linewidth=1.5, **kwargs):
    ...
    return ax.plot(
        *data, *args, zorder=zorder, alpha=alpha, linewidth=linewidth, **kwargs
    )
...
def plot_scatter(x, y, *args, zorder=1000, ax=None, alpha=0.9, legend=False, **kwargs):
    ...
    return sns.scatterplot(
        *data, *args, ax=ax, zorder=zorder, alpha=alpha, legend=legend, **kwargs
    )
...
def format_axes(
    ax=None, xlim=None, ylim=None, num_major=3, num_minor=5, despine=False, grid=None
):
...
_DEFAULT_AX = None
_DEFAULT_STYLE = AttrDict(
    data=ObjectStyle(color="black"),
